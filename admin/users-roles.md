...
1. Click **Invite User** on the Users & Roles page.
2. Enter the recipient’s email address.
3. Select one or more roles for their access level.
4. (Optional) Add a message to include in the invitation email.
5. Send the invite. The user must accept the email invitation before they can sign in.
